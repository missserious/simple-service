...
public class Server {
    ...
    private static final String CONTENT_PATH = "/frontend";
    ...
    public static void main(String[] args) throws IOException, URISyntaxException, InterruptedException {
        ...
        final Application application = Application.builder(ResourceConfig.builder().packages(Server.class.getPackage().getName()).build()).build();
        ...
        // set up MongoDB
        MongoURI mongolabUri = new MongoURI(System.getenv("MONGOLAB_URI") != null ? System.getenv("MONGOLAB_URI") : "mongodb://127.0.0.1:27017/locationtracker");
